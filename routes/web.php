...
Route::prefix('/order')->group(function(){
    ...
    Route::get('alipay/{id}','Index\OrderController@alipay');
    Route::get('returnUrl','Index\OrderController@returnUrl');
    Route::get('malipay/{id}','Index\OrderController@malipay');
});

//内侧 文章
Route::prefix('wen')->group(function(){
    Route::get('add','WenController@create');
    Route::post('update','WenController@update');
//唯一性
    Route::post('checkName','WenController@checkName');
    Route::post('add_do','WenController@store');
    Route::post('ces','WenController@ces');
    Route::get('list','WenController@index');
    Route::get('info/{id}','WenController@info');
    Route::get('edit/{id}','WenController@edit');
    Route::post('del/{id}','WenController@destroy');
});
